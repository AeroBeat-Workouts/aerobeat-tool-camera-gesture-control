...
func test_readme_states_runtime_and_testbed_boundaries() -> void:
	...
	assert_true(readme_text.contains("16:9 harness"), "README should describe the upgraded harness layout")
	assert_true(readme_text.contains("trace-capture scaffolding"), "README should mention the trace export seam")
